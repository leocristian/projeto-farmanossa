...
begin
  ...
  begin
    ...
    try
      ...
      q1.SQL.Add('on sai_produto = prod_codigo');
      q1.SQL.Add('inner join tb_locais_estoque as l');
      q1.SQL.Add('on loc_codigo = sai_local');
      q1.SQL.Add('inner join tb_lotes as lotes');
      q1.SQL.Add('on lote_codigo = sai_lote');
