...
begin
  ...
  begin
    ...
    xWhere := xWhere + ' and to_char(sai_data_hora::date, ''dd/mm/yyyy'') >= ' + QuotedStr(dataInicial) +
                       ' and to_char(sai_data_hora::date, ''dd/mm/yyyy'') <= ' + QuotedStr(dataFinal);
  end;
  ...
  begin
    ...
    xWhere := xWhere + ' and sai_codigo >= ' + codInicial + ' and sai_codigo <= ' + codFinal;
  end;
  ...
  begin
    try
      try
        ...
        dm1.q1.SQL.Text := 'delete from tb_saidas where sai_codigo = :saida';
