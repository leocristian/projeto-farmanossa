...
begin
  ...
  begin
    try
      ...
      dm1.q1.SQL.Add(' from tb_entradas as e');
      dm1.q1.SQL.Add('left join tb_produtos as p on ent_produto = prod_codigo');
      dm1.q1.SQL.Add('left join tb_locais_estoque as l on loc_codigo = ent_local');
      dm1.q1.SQL.Add('left join tb_lotes as lotes on lote_codigo = ent_lote');
...
begin
  ...
  if Confirma('Confirmar nova entrada?') then
  begin
    ...
    try
      ...
      if ModoLote.Text = 'N' then  // Adicionar novo lote
      begin
      ...
      else if ModoLote.text = 'A' then // Alterar lote existente
      begin
