...
begin
  ...
  begin
    ...
    try
      ...
      q1.SQL.Add('inner join tb_entradas as e on ent_produto = prod_codigo');
      q1.SQL.Add('inner join tb_locais_estoque as l on loc_codigo = ent_local');
      q1.SQL.Add('inner join tb_lotes as lotes on lote_codigo = ent_lote');
    ...
    begin
      try
        ...
        begin
          ...
          q1.ParamByName('local').Value := CodLocalEdit.Text;
          q1.ParamByName('lote').Value := LoteEdit.Text;
          q1.ParamByName('operacao').Value := 'E';
          q1.ParamByName('quantidade').Value := QtdProdEdit.Value;
          q1.ParamByName('cod_operacao').Value := ent_codigo;
