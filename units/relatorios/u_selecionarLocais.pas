...
begin
  ...
  begin
    ...
    begin
      if codigos = '' then
      begin
        codigos := vt_locais.FieldByName('loc_codigo').AsString;
      end
      else
      begin
